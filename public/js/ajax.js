...
$(document).ready(function () {
    ...
    function updateInputFieldColors(response, index) {
        response.forEach(function (item, idx) {
            ...
            if (item.state === 1) {
                setTimeout(function () {
                    inputField.css('background-color', 'hsl(49, 51%, 47%)').prop('disabled', true);
                }, idx * 300);
            } else if (item.state === 0) {
                setTimeout(function () {
                    inputField.css('background-color', 'hsl(115, 29%, 43%)').prop('disabled', true);
                }, idx * 300);
            } else {
                setTimeout(function () {
                    inputField.css('background-color', 'hsl(240, 2%, 23%)').prop('disabled', true);
                }, idx * 300);
            }
